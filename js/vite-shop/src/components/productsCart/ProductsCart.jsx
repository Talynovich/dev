  ...
  return (
    <div className="flex flex-col rounded-lg border border-gray-200 bg-white transition hover:bg-gray-50 shadow-sm hover:shadow-md duration-300 relative">
      ...
      <img
        src={product.image}
        alt={product.name}
        className="object-cover relative aspect-square bg-gray-100 overflow-hidden rounded-t-lg w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
      />
